	...
	<!-- 첫 페이지 화면 // 충전 내역 데이터베이스 목록 7개로 제한-->
        ...
        <br><br>
            ...
            <br><br>
				 ...
				 <c:forEach var="foruse" items="${recharge}">
				 <tr height=50>
		...
		<ul class="tab_Menu1">
            ...
            <br><br>		
				 ...
				 <c:forEach var="foruse" items="${re1week}">
				 <tr height=50>
				 <td width=100>${foruse.date}</td>
				 <td width=100>${foruse.mn_price}</td>
				 </tr>
            ...
            <br><br>		
				 ...
				 <c:forEach var="foruse" items="${re1month}">
				 <tr height=50>
				 <td width=100>${foruse.date}</td>
				 <td width=100>${foruse.mn_price}</td>
				 </tr> 
            ...
            <br><br>		
				 ...
				 <c:forEach var="foruse" items="${re3month}">
				 <tr height=50>
				 <td width=100>${foruse.date}</td>
				 <td width=100>${foruse.mn_price}</td>
				 </tr> 
		...
		<!-- 충전 매출 내역 누를때의 페이지 화면 // 충전 내역 데이터베이스 목록 7개로 제한-->
		...
		<div id="tabContent02" class="tabPage">
            ...
            <tr><td>
            <form method="post" action="Stu_TotRecharge.do">
            <input type="text" name="Re_revenue">
            <input type="submit" value="조회">
            </form>
            </td></tr>
            <tr><td>원하는 월 입력 : ex)2017-07</td></tr>
            <c:forEach var="rm" items="${Rn_rm}">
            <tr>
            <td>월별 매출 : ${rm.r_money}</td>
            </tr>
			</c:forEach>
			</table>
			</div>
